...
namespace Controlador
{
    public partial class Form5 : Form
    {
        ...
        public Form5()
        {
            ...
            if (client != null)
            {
                MessageBox.Show("Conexión Establecida con Servidor C");
            }
        ...
        private void Exportar(object sender, ElapsedEventArgs e)
        {
            ...
            {
                timer.Stop();
                MessageBox.Show("Fuego detectado, apagando Sensor C");
            } else if (!fireOn)
            {
                Export();
            }
        ...
        private async void Export()
        {
            ...
            FirebaseResponse resp = await client.GetTaskAsync("CounterC/node");
            ...
            SetResponse response = await client.SetTaskAsync("SensorC/" + data.Id, data);
            ...
            SetResponse response1 = await client.SetTaskAsync("CounterC/node", obj);
