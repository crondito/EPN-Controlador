...
namespace Controlador
{
    public partial class Form3 : Form
    {
        ...
        public Form3()
        {
            ...
            if (client != null)
            {
                MessageBox.Show("Conexión Establecida con Servidor A");
            }
        ...
        private void Exportar(object sender, ElapsedEventArgs e)
        {
            ...
            {
                timer.Stop();
                MessageBox.Show("Fuego detectado, apagando Sensor A");
            } else if (!fireOn)
            {
                Export();
            }
        ...
        private async void Export()
        {
            ...
            SetResponse response = await client.SetTaskAsync("SensorA/" + data.Id, data);
